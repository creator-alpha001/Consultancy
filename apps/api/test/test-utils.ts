...
export async function resetDatabase(pool: Pool): Promise<void> {
  await pool.query(`
    TRUNCATE TABLE
      auth_events, recovery_codes, auth_factors, user_sessions, account_tokens, provider_profiles,
      ...
      session_messages, session_shared_files, session_interruptions,
      session_extensions, agreements,
      transcripts, session_recordings, session_consents, session_participants, sessions,
      result_list_entries,
