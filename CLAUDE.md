...
| `docs/ACCOUNTS-AND-ONBOARDING.md` | Sign-in, reset, email, sessions, profiles, seeker fields, mentor readiness and verification | Anything in `identity/`, `notifications/email/`, readiness or onboarding screens |
